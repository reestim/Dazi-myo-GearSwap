...
function init_gear_sets()
    ...
    sets.precast.BloodPactWard = {main="Espiritus",sub="Vox Grip",ammo="Idaraaja",
    ...
    sets.precast.WS['Myrkr'] = {ammo="Idaraaja",
	...
	sets.midcast['Summoning Magic'] = {main="Malignance Pole",sub="Umbra Strap",ammo="Idaraaja",
        head="Beckoner's Horn +1",neck="Incanter's Torque",ear1="Andoaa Earring",ear2="Lodurr Earring",
    ...
    sets.midcast.Pet.BloodPactWard = {main="Espiritus",sub="Vox Grip",ammo="Idaraaja",
        head="Beckoner's Horn +1",neck="Incanter's Torque",ear1="Andoaa Earring",ear2="Lodurr Earring",
        body="Baayami Robe",hands="Baayami Cuffs",ring1="Evoker's Ring",ring2="Stikini Ring +1",
        back="Conveyance Cape",waist="Kobo Obi",legs="Baayami Slops",feet="Baayami Sabots"}

    sets.midcast.Pet.DebuffBloodPactWard = {main="Espiritus",sub="Vox Grip",ammo="Idaraaja",
    ...
    sets.midcast.Pet.PhysicalBloodPactRage = {main="Gridarvor",sub="Elan Strap +1",ammo="Idaraaja",
    ...
    sets.midcast.Pet.MagicalBloodPactRage = {main=gear.grioavolr_pet_staff,sub="Elan Strap +1",ammo="Idaraaja",
	...
	sets.midcast.Pet['Flaming Crush'] = {main=gear.grioavolr_pet_staff,sub="Elan Strap +1",ammo="Idaraaja",
        head="Apogee Crown +1",neck="Adad Amulet",ear1="Lugalbanda Earring",ear2="Gelos Earring",
        body="con. doublet +1",hands=gear.merlinic_magpact_hands,ring1="Varar Ring +1",ring2="Varar Ring +1",
    ...
    sets.idle.PDT = {main="Malignance Pole",sub="Oneiros Grip",ammo="Staunch Tathlum +1",
        head="//'s Horn +3",neck="Loricate Torque +1",ear1="C. Palug Earring",ear2="Ethereal Earring",
    ...
    sets.idle.Avatar = {main="Gridarvor",sub="Oneiros Grip",ammo="Idaraaja",
    ...
    sets.idle.PDT.Avatar = {main="Malignance Pole",sub="Oneiros Grip",ammo="Idaraaja",
    ...
    sets.idle.Spirit = {main="Gridarvor",sub="Oneiros Grip",ammo="Idaraaja",
    ...
    sets.idle.PDT.Spirit = {main="Malignance Pole",sub="Oneiros Grip",ammo="Idaraaja",
        head="Beckoner's Horn +1",neck="Loricate Torque +1",ear1="C. Palug Earring",ear2="Evans Earring",
        body="Shomonjijoe +1",hands=gear.merlinic_refresh_hands,ring1="Defending Ring",ring2="Dark Ring",
    ...
    -- Defense sets
    sets.defense.PDT = {main="Malignance Pole",sub="Umbra Strap",ammo="Idaraaja",
        head="Beckoner's Horn +1",neck="Loricate Torque +1",ear1="Handler's Earring +1",ear2="Enmerkar Earring",
        body="Shomonjijoe +1",hands=gear.merlinic_refresh_hands,ring1="Defending Ring",ring2="Dark Ring",
        back="Moonlight Cape",waist="Regal Belt",legs="Assid. Pants +1",feet="Baayami Sabots"}

    sets.defense.MDT = {main="Malignance Pole",sub="Umbra Strap",ammo="Idaraaja",
        head="Beckoner's Horn +1",neck="Loricate Torque +1",ear1="Handler's Earring +1",ear2="Enmerkar Earring",
        body="Shomonjijoe +1",hands=gear.merlinic_refresh_hands,ring1="Defending Ring",ring2="Dark Ring",
        back="Moonlight Cape",waist="Regal Belt",legs="Assid. Pants +1",feet="Baayami Sabots"}

    sets.defense.MEVA = {main="Malignance Pole",sub="Enki Strap",ammo="Idaraaja",
    ...
    -- Normal melee group
    sets.engaged = {main="Gridarvor",sub="Bloodrain Strap",ammo="Idaraaja",
