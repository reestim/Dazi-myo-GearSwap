...
function init_gear_sets()
	...
	sets.TreasureHunter = {	hands={ name="Plun. Armlets", augments={'Enhances "Perfect Dodge" effect',}},right_ring="Gorney Ring",}
    sets.ExtraRegen = {}
    ...
    sets.defense.PDT = {ammo="Staunch Tathlum +1",
        head="Malignance Chapeau",neck="Twilight Torque",ear1="Etiolation Earring",ear2="Sanare Earring",
    ...
    -- Normal melee group
    sets.engaged = {ammo="Ginsen",head="Meghanada Visor +1",body="Meg. Cuirie +1",hands="Adhemar Wristbands",
		legs={ name="Samnuha Tights", augments={'STR+1','DEX+4','"Dbl.Atk."+1',}},feet="Meg. Jam. +1",
		neck="Clotharius Torque",waist="Windbuffet Belt",left_ear="Dedition Earring",right_ear="Brutal Earring",
		left_ring="Epona's Ring",right_ring="Rajas Ring",back={ name="Toutatis's Cape", augments={'DEX+20','Accuracy+20 Attack+20','"Dbl.Atk."+10',}},}
	...
	sets.engaged.Acc = {ammo="Yamarang",
        head="Pill. Bonnet +3",neck="Assassin's Gorget",ear1="Suppanomimi",ear2="Telos Earring",
