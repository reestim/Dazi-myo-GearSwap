...
gear.herculean_ta_head = { name="Herculean Helm", augments={'Accuracy+22','"Triple Atk."+4','AGI+1',} }
--====HANDS====----
...
gear.herculean_ta_hands = { name="Herculean Gloves", augments={'Attack+30','"Triple Atk."+3','DEX+1','Accuracy+7',}}
--====BODY====----
...
gear.herculean_wsd_legs = {name = "Herculean Trousers", augments = { 'Attack+28', 'Weapon skill damage +3%', 'STR+10', 'Accuracy+9', }}
...
gear.herculean_ta_feet = {name="Herculean Boots",augments={'Accuracy+19 Attack+19','"Triple Atk."+2','VIT+9','Attack+14',}}
gear.herculean_refresh_feet = {name="Herculean Boots",augments={'MND+4','Accuracy+16 Attack+16','"Refresh"+2',}}
