...
function init_gear_sets()
	...
	sets.precast.WS = {ammo="Knobkierrie",
            ...
            body="Adhemar Jacket +1",hands="Meg. Gloves +1",ring1="Epona's Ring",ring2="Apate Ring",
            back=gear.da_jse_back,waist="Fotia Belt",legs="Ayanmo Cosciales +1",feet=gear.herculean_ta_feet}
	sets.precast.WS.SomeAcc = {ammo="Voluspa Tathlum",
            ...
            body="Ayanmo Corazza +2",hands="Meg. Gloves +1",ring1="Niqmaddu Ring",ring2="Regal Ring",
            back=gear.da_jse_back,waist="Fotia Belt",legs="Ayanmo Cosciales +1",feet=gear.herculean_ta_feet}
	...
	sets.precast.WS.HighAcc = {ammo="C. Palug Stone",
            ...
            body="Ayanmo Corazza +2",hands="Meg. Gloves +1",ring1="Niqmaddu Ring",ring2="Regal Ring",
            back=gear.da_jse_back,waist="Fotia Belt",legs="Ayanmo Cosciales +1",feet=gear.herculean_acc_feet}
	sets.precast.WS.FullAcc = {ammo="C. Palug Stone",
            ...
            body="Meg. Cuirie +2",hands="Meg. Gloves +1",ring1="Ramuh Ring +1",ring2="Ramuh Ring +1",
            back=gear.stp_jse_back,waist="Fotia Belt",legs="Ayanmo Cosciales +1",feet=gear.herculean_acc_feet}
	...
	sets.engaged.HighAcc = {main="Lionheart",sub="Utu Grip",ammo="C. Palug Stone",
            ...
            body="Ayanmo Corazza +2",hands="Meg. Gloves +1",ring1="Niqmaddu Ring",ring2="Ilabrat Ring",
