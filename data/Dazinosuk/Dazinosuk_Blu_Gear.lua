function user_job_setup()
	...
	state.Weapons:options('Kaja','Tizalmace','Sequence','None','Almace','MagicWeapons','MeleeClubs','MaccWeapons','HybridWeapons')
	...
	gear.wsd_jse_back = {name="Rosmerta's Cape",augments={'STR+20','Weapon skill damage +10%',}}
	gear.nuke_jse_back = {name="Seshaw Cape"}
...
function init_gear_sets()
	...
	sets.HPDown = {head="Pixie Hairpin +1",neck="Loricate Torque +1",ear1="Mendicant's Earring",ear2="Evans Earring",
		...
		back="Swith Cape +1",waist="Flume Belt +1",legs="Shedir Seraweels",feet="Jhakri Pigaches +1"}
	...
	sets.precast.FC = {ammo="Impatiens",head="Amalric coif",body="Jhakri Robe +2",hands="Leyline Gloves",
		legs="Psycloth Lappas",feet="Jhakri Pigaches +1",neck="Stoicheion Medal",waist="Witful Belt",
		left_ear="Loquac. Earring",right_ear="Hecate's Earring",left_ring="Lebeche Ring",right_ring="Jhakri Ring",}
	...
	sets.precast.WS.Acc = {ammo="Falcon Eye",
				  ...
				  body="Assim. Jubbah +2",hands="Assim. Bazu. +3",ring1="Epona's Ring",ring2="Ilabrat Ring",
	...
	sets.precast.WS['Requiescat'] = set_combine(sets.precast.WS, {ammo = "Quartz Tathlum +1",head = "Jhakri Coronal +1",
        neck = "Fotia Gorget",ear1 = "Moonshade Earring",ear2 = "Brutal Earring",body = "Jhakri Robe +2",
        hands = "Jhakri Cuffs +1",ring1 = "Epona's ring",ring2 = "Rufescent Ring",back = gear.wsd_jse_back,
        waist = "Fotia Belt",legs = "Jhakri Slops +2",feet = "Jhakri Pigaches +1"})
	sets.precast.WS['Requiescat'].Acc = set_combine(sets.precast.WS.Acc, {ammo = "Quartz Tathlum +1",head = "Jhakri Coronal +1",
        neck = "Fotia Gorget",ear1 = "Moonshade Earring",ear2 = "Brutal Earring",body = "Jhakri Robe +2",
        hands = "Jhakri Cuffs +1",ring1 = "Epona's ring",ring2 = "Rufescent Ring",back = gear.wsd_jse_back,
        waist = "Fotia Belt",legs = "Carmine Cuisses +1",feet = "Jhakri Pigaches +1"})
	...
	sets.precast.WS['Realmrazer'] = set_combine(sets.precast.WS, {head="Jhakri Coronal +1",ear1="Regal Earring",body="Jhakri Robe +2",ring2="Rufescent Ring",legs="Jhakri Slops +2",feet="Jhakri Pigaches +1"})
	sets.precast.WS['Realmrazer'].Acc = set_combine(sets.precast.WS.Acc, {head="Jhakri Coronal +1",ear1="Regal Earring",ear2="Telos Earring",ring1="Rufescent Ring",legs="Jhakri Slops +2",feet="Jhakri Pigaches +1"})
	...
	sets.precast.WS['Chant du Cygne'] = set_combine(sets.precast.WS, {ammo="Jukukik Feather",
		...
		body="Ayanmo Corazza +2",hands=gear.herculean_ta_hands,legs="Jhakri Slops +2",feet="Jhakri Pigaches +1",
		neck="Fotia Gorget",waist="Fotia Belt",left_ear="Ishvara Earring",right_ear="Moonshade Earring",
		left_ring="Ilabrat Ring",right_ring="Epona's Ring",back=gear.wsd_jse_back,})
	sets.precast.WS['Chant du Cygne'].Acc = set_combine(sets.precast.WS.Acc, {ammo="Jukukik Feather",
		head={ name="Lilitu Headpiece", augments={'STR+10','DEX+10','Attack+15','Weapon skill damage +3%',}},
		body="Ayanmo Corazza +2",hands=gear.herculean_ta_hands,legs="Carmine Cuisses +1",feet="Jhakri Pigaches +1",
		neck="Fotia Gorget",waist="Fotia Belt",left_ear="Ishvara Earring",right_ear="Moonshade Earring",
		left_ring="Ilabrat Ring",right_ring="Epona's Ring",back=gear.wsd_jse_back,})
	...
	sets.precast.WS['Savage Blade'] = set_combine(sets.precast.WS, {ammo="Ginsen", head={ name="Lilitu Headpiece", augments={'STR+10','DEX+10','Attack+15','Weapon skill damage +3%',}},
		body="Ayanmo Corazza +2",hands=gear.herculean_ta_hands,legs="Jhakri Slops +2",feet="Jhakri Pigaches +1",
		neck="Fotia Gorget",waist="Fotia Belt",left_ear="Ishvara Earring",right_ear="Moonshade Earring",
		left_ring="Rufescent Ring",right_ring="Epona's Ring",back=gear.wsd_jse_back,})
	sets.precast.WS['Savage Blade'].Acc = set_combine(sets.precast.WS.Acc, {ear1="Moonshade Earring",hands="Jhakri Cuffs +1",back=gear.wsd_jse_back,waist="Grunfeld Rope",legs="Carmine Cuisses +1",feet=gear.herculean_wsd_feet})
	...
	sets.precast.WS['Expiacion'] = set_combine(sets.precast.WS, {head="Lilitu Headpiece",neck="Caro Necklace",ear1="Moonshade Earring",ear2="Ishvara Earring",body="Assim. Jubbah +2",hands="Jhakri Cuffs +1",ring1="Rufescent Ring",ring2="Rufescent Ring",back=gear.wsd_jse_back,waist="Sailfi Belt +1",legs=gear.herculean_wsd_legs,feet=gear.herculean_wsd_feet})
	sets.precast.WS['Expiacion'].Acc = set_combine(sets.precast.WS.Acc, {ear1="Moonshade Earring",body="Assim. Jubbah +2",hands="Jhakri Cuffs +1",back=gear.wsd_jse_back,legs="Carmine Cuisses +1",feet=gear.herculean_wsd_feet})
	sets.precast.WS['Expiacion'].FullAcc = set_combine(sets.precast.WS.FullAcc, {body="Assim. Jubbah +2",hands="Jhakri Cuffs +1"})
	...
	sets.precast.WS['Sanguine Blade'] = {ammo="Ginsen",head={ name="Lilitu Headpiece", augments={'STR+10','DEX+10','Attack+15','Weapon skill damage +3%',}},body="Jhakri Robe +2",hands=gear.herculean_ta_hands,legs="Jhakri Slops +2",feet="Jhakri Pigaches +1",neck="Fotia Gorget",waist="Fotia Belt",left_ear="Friomisi Earring",right_ear="Ishvara Earring",left_ring="Rufescent Ring",right_ring="Epona's Ring",back=gear.wsd_jse_back,}
	...
	sets.precast.WS['Flash Nova'] = {ammo="Pemphredo Tathlum",
		             ...
		             body="Jhakri Robe +2",hands="Jhakri Cuffs +1",ring1="Metamor. Ring +1",ring2="Shiva Ring +1",
			         back=gear.nuke_jse_back,waist="Yamabuki-no-Obi",legs="Jhakri Slops +2",feet="Jhakri Pigaches +1"}
	...
	sets.midcast['Blue Magic'].Physical = {main="Vampirism",sub="Vampirism",ammo="Mavi Tathlum",
		...
		body="Jhakri Robe +2",hands="Jhakri Cuffs +1",ring1="Rufescent Ring",ring2="Ilabrat Ring",
	...
	sets.midcast['Blue Magic'].Physical.Resistant = {main="Sequence",sub="Almace",ammo="Falcon Eye",
		head="Jhakri Coronal +1",neck="Mirage Stole +1",ear1="Regal Earring",ear2="Telos Earring",
	    body="Assim. Jubbah +2",hands="Assim. Bazu. +3",ring1="Ramuh Ring +1",ring2="Ramuh Ring +1",
	...
	sets.midcast['Blue Magic'].Physical.Fodder = {main="Iris",sub="Iris",ammo="Mavi Tathlum",
		head="Luh. Keffiyeh +1",neck="Mirage Stole +1",ear1="Suppanomimi",ear2="Telos Earring",
		body="Assim. Jubbah +2",hands="Jhakri Cuffs +1",ring1="Rufescent Ring",ring2="Ilabrat Ring",
	...
	sets.midcast['Blue Magic'].PhysicalAcc = {main="Sequence",sub="Almace",ammo="Falcon Eye",
		head="Jhakri Coronal +1",neck="Mirage Stole +1",ear1="Regal Earring",ear2="Telos Earring",
	    body="Assim. Jubbah +2",hands="Jhakri Cuffs +1",ring1="Ramuh Ring +1",ring2="Ilabrat Ring",
	...
	sets.midcast['Blue Magic'].Magical = {main="Nibiru Cudgel",sub="Nibiru Cudgel",ammo="Pemphredo Tathlum",
		 head="Jhakri Coronal +1",neck="Baetyl Pendant",ear1="Hecate Earring",ear2="Friomisi Earring",
		 body="Jhakri Robe +2",hands="Jhakri Cuffs +1",ring1="Metamor. Ring +1",ring2="Jhakri Ring",
		 back=gear.nuke_jse_back,waist=gear.ElementalObi,legs="Jhakri Slops +2",feet="Jhakri Pigaches +1"}
	...
	sets.midcast['Blue Magic'].Magical.Resistant = set_combine(sets.midcast['Blue Magic'].Magical,
		{neck="Mirage Stole +1",hands="Jhakri Cuffs +1",ring1="Stikini Ring +1",ring2="Stikini Ring +1",waist="Yamabuki-no-Obi"})
	...
	sets.midcast['Blue Magic'].Magical.Fodder = {main="Nibiru Cudgel",sub="Nibiru Cudgel",ammo="Pemphredo Tathlum",
		 ...
		 back=gear.ElementalCape,waist=gear.ElementalObi,legs="Jhakri Slops +2",feet="Jhakri Pigaches +1"}
	...
	sets.midcast['Dark Magic'] = {main="Nibiru Cudgel",sub="Nibiru Cudgel",ammo="Pemphredo Tathlum",
		...
		body="Jhakri Robe +2",hands="Jhakri Cuffs +1",ring1="Metamor. Ring +1",ring2="Stikini Ring +1",
		back=gear.nuke_jse_back,waist="Luminary Sash",legs="Jhakri Slops +2",feet="Jhakri Pigaches +1"}
	...
	sets.midcast['Elemental Magic'] = {main="Nibiru Cudgel",sub="Nibiru Cudgel",ammo="Dosis Tathlum",
		...
		back=gear.nuke_jse_back,waist=gear.ElementalObi,legs="Hagondes Pants +1",feet="Jhakri Pigaches +1"}
	...
	sets.midcast['Blue Magic'].Breath = {ammo="Mavi Tathlum",
		head="Luh. Keffiyeh +1",neck="Mirage Stole +1",ear1="Regal Earring",ear2="Digni. Earring",
	...
	sets.midcast['Blue Magic'].SkillBasedBuff = {main="Iris",sub="Iris",ammo="Mavi Tathlum",
		head="Luh. Keffiyeh +1",neck="Mirage Stole +1",ear1="Gifted Earring",ear2="Loquac. Earring",
	...
	sets.idle = {main="Bolelabunga",sub="Genmei Shield",ammo="Staunch Tathlum +1",
			      ...
			      body="Assimilator's Jubbah +2",hands=gear.herculean_refresh_hands,ring1="Stikini Ring +1",ring2="Stikini Ring +1",
			      back="Kumbira cape",waist="Fucho-no-obi",legs="Carmine Cuisses +1",feet=gear.herculean_refresh_feet}
	...
	sets.idle.PDT = {main="Mafic Cudgel",sub="Genmei Shield",ammo="Staunch Tathlum +1",
		        ...
		        body="Assimilator's Jubbah +2",hands="Malignance Gloves",ring1="Defending Ring",ring2="Dark Ring",
	...
	sets.defense.PDT = {main="Mafic Cudgel",sub="Genmei Shield",ammo="Staunch Tathlum +1",
		        ...
		        body="Malignance Tabard",hands=gear.herculean_ta_hands,ring1="Defending Ring",ring2="Shadow Ring",
	...
	sets.weapons.thib = {main="Machaera" , sub = "Colada"}

	-- Engaged sets

	sets.engaged = {main="Tizona",sub="Almace",ammo="Ginsen",
			    head=gear.herculean_ta_head,neck="Lissome Necklace",ear1="Dedition Earring",ear2="Suppanomimi",
			    body="Ayanmo Corazza +2",hands=gear.herculean_ta_hands,ring1="Epona's Ring",ring2="Petrov Ring",
	...
	sets.engaged.Acc = {main="Tizona",sub="Almace",ammo="Ginsen", head="Ayanmo zucchetto +1",body="Ayanmo Corazza +2",
				hands="Ayanmo manopolas +1",legs="Carmine Cuisses +1",feet="Ayanmo Gambieras +1",neck="Mirage Stole +1",
				waist="Kentarch Belt",left_ear="Suppanomimi",right_ear="Cessance Earring",left_ring="Petrov Ring",
				right_ring="Epona's Ring",}

	sets.engaged.Acc.AM = {main="Tizona",sub="Almace",ammo="Ginsen",
			    head=gear.herculean_ta_head,neck="Mirage Stole +1",ear1="Digni. Earring",ear2="Telos Earring",
			    body="Malignance Tabard",hands=gear.herculean_ta_hands,ring1="Epona's Ring",ring2="Ilabrat Ring",
			    back=gear.stp_jse_back,waist="Windbuffet Belt",legs="Carmine Cuisses +1",feet="Malignance Boots"}

	sets.engaged.FullAcc = {main="Tizona",sub="Almace",ammo="Ginsen",
				ammo="Ginsen",head="Ayanmo zucchetto +1",body="Ayanmo Corazza +2",
		hands="Ayanmo manopolas +1",legs="Carmine Cuisses +1",feet="Ayanmo Gambieras +1",neck="Lissome Necklace",
		waist="Kentarch Belt",left_ear="Suppanomimi",right_ear="Dedition Earring",left_ring="Jhakri Ring",
		right_ring="Epona's Ring",back=gear.da_jse_back,}

	sets.engaged.FullAcc.AM = {main="Tizona",sub="Almace",ammo="Ginsen",
			    head="Carmine Mask +1",neck="Mirage Stole +1",ear1="Mache Earring +1",ear2="Telos Earring",
	...
	sets.engaged.Fodder = {main="Tizona",sub="Almace",ammo="Ginsen",
				head=gear.herculean_ta_head,neck="Mirage Stole +1",ear1="Cessance Earring",ear2="Suppanomimi",
				body="Ayanmo Corazza +2",hands=gear.herculean_ta_hands,ring1="Epona's Ring",ring2="Petrov Ring",
				back=gear.da_jse_back,waist="Windbuffet Belt",legs="Carmine Cuisses +1",feet="Malignance Boots"}
	...
	sets.engaged.DT = {main="Tizona",sub="Almace",ammo="Aurgelmir Orb +1",
			    ...
			    body="Ayanmo Corazza +2",hands=gear.herculean_ta_hands,ring1="Defending Ring",ring2="Petrov Ring",
	...
	sets.engaged.Acc.DT = {main="Tizona",sub="Almace",ammo="Falcon Eye",
			    ...
			    body="Malignance Tabard",hands=gear.herculean_ta_hands,ring1="Defending Ring",ring2="Ilabrat Ring",
	...
	sets.engaged.FullAcc.DT = {main="Tizona",sub="Almace",ammo="Falcon Eye",
			    ...
			    body="Malignance Tabard",hands=gear.herculean_ta_hands,ring1="Defending Ring",ring2="Ramuh Ring +1",
			    back=gear.da_jse_back,waist="Reiki Yotai",legs="Malignance Tights",feet="Malignance Boots"}

	sets.engaged.Fodder.DT = {main="Tizona",sub="Almace",ammo="Aurgelmir Orb +1",
			    head="Malignance Chapeau",neck="Loricate Torque +1",ear1="Cessance Earring",ear2="Brutal Earring",
			    body="Malignance Tabard",hands=gear.herculean_ta_hands,ring1="Defending Ring",ring2="Petrov Ring",
			    back=gear.da_jse_back,waist="Reiki Yotai",legs="Malignance Tights",feet="Malignance Boots"}
